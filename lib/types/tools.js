...
const DESCRIPTION = 'Report the latest connectivity and latency check for every model currently registered with a provider. '
 ...
 */
export function registerModelHealthTool(ctx, deps) {
