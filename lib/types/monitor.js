 ...
 */
export const CREDENTIAL_PENDING_CODES = new Set(['MISSING_CREDENTIAL']);
...
export class ModelHealthMonitor {
    ...
    dispose() {
        ...
        if (this.credentialTimer !== undefined)
    ...
    armCredentialRetry() {
        if (this.disposed || this.credentialTimer !== undefined)
            return;
